...
- (Optional) **qt5-styleplugins** for making QT and KDE applications look the same as gnome applications
...
```
git clone https://github.com/MCassimus/material-awesome.git ~/.config/awesome
```
...
First install `qt5-styleplugins` and add this to the bottom of your `/etc/environment`
